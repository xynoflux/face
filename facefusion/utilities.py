...
def download_file(download_directory_path : str, url : str) -> None:
	...
	if initial < total:
		...
		with tqdm(total = total, initial = initial, desc = wording.get('downloading'), unit_scale = True, unit_divisor = 1024, bar_format = bar_format) as progress:
